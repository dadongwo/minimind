...
warnings.filterwarnings('ignore', category=UserWarning, message='.*DirectML.*')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniMind Pretraining - AMD Compatible")
    ...
    args.wandb_run_name = f"MiniMind-Pretrain-{device_type.upper()}-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
